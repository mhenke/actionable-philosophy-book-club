 ...
 *
 * All 14 IDs must exist in index.html — they are static elements baked into the
 ...
 * upcomingCardHeader, upcomingMaterialsContainer, upcomingKeyTakeaway, upcomingWhatToRead,
 * upcomingCta, upcomingAdditional, archiveCardsContainer, draftCardsContainer, siteFooter
 *
...
const upcomingWhatToRead = document.getElementById('upcoming-what-to-read');
...
window.DOM = { dashboard, reader, markdownContent, readerStatus, upcomingCardHeader, upcomingMaterialsContainer, upcomingKeyTakeaway, upcomingWhatToRead, upcomingCta, upcomingAdditional, archiveCardsContainer, draftCardsContainer, siteFooter };
})();
