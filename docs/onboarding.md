...
- **Welcome Banner** — If you dismissed the welcome banner on the dashboard, you can restore it anytime: <button class="restore-onboarding-action hover:text-spectrum-2 transition-colors cursor-pointer font-semibold uppercase tracking-wider text-xs text-spectrum-2 underline">Reset Welcome Banner</button>
